...
while 1:
    ...
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder Normal (Ortalama Gönderim)\n\n 2- SMS Gönder VIP (Hızlı Saldırı Modu)\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Hatalı giriş yaptıniz. Tekrar deneyiniz.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
